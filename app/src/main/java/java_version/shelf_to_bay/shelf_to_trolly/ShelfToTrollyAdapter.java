...
public class ShelfToTrollyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShelfToTrollyAdapter(List<JobItem> jobs, Context context) {
        this.jobsList = jobs;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.tvItemStatus.setText(job.getBayTitle()!=null? job.getBayTitle():"");
