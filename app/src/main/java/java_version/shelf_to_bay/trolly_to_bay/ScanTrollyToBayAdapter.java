...
public class ScanTrollyToBayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ScanTrollyToBayAdapter(List<JobItem> jobs, Context context) {
        this.jobsList = jobs;
