...
public class ScanBundleToBayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ScanBundleToBayAdapter(List<JobItem> jobs, Context context) {
        this.jobsList = jobs;
