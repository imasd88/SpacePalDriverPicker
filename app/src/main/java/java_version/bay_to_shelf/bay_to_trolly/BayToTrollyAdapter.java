...
public class BayToTrollyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BayToTrollyAdapter(List<JobItem> jobs, Context context) {
        this.jobsList = jobs;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.tvItemStatus.setText("Loading bay "+job.getBayTitle()!=null? job.getBayTitle():"");
